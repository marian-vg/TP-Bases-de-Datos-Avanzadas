...
-- 16. Tipos de recurso aplicables por tipo de incidente
...
-- 17. Tipos de incidente derivados por tipo de evento
...
-- 18. Historial de mantenimiento derivado del CSV legado de sensores.
INSERT INTO MantenimientoSensor (fk_sensor_id, fecha)
SELECT id_sensor, fecha_mantenimiento
FROM Sensor
WHERE fecha_mantenimiento IS NOT NULL;
